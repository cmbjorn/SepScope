"""
Comprehensive Word (.docx) design report generator for VesselCalc.
...
def _cover(doc: Document, project_name: str, vessel_tag: str,
    ...
    p_disc = doc.add_paragraph(
        "This document is generated by VesselCalc. Calculations are screening-level only. "
        "All results must be verified by a qualified pressure vessel engineer before use."
    )
...
def generate_word_report(
    ...
    notes = [
        ...
        "This document is generated by VesselCalc and is not a certified engineering calculation.",
    ]
